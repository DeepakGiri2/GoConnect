...
const (
	...
	AuthService_ResendVerificationOTP_FullMethodName     = "/auth.AuthService/ResendVerificationOTP"
	AuthService_GetBlockStatus_FullMethodName            = "/auth.AuthService/GetBlockStatus"
	AuthService_SetupTOTP_FullMethodName                 = "/auth.AuthService/SetupTOTP"
...
type AuthServiceClient interface {
	...
	ResendVerificationOTP(ctx context.Context, in *ResendOTPRequest, opts ...grpc.CallOption) (*ResendOTPResponse, error)
...
func (c *authServiceClient) ResendVerificationOTP(ctx context.Context, in *ResendOTPRequest, opts ...grpc.CallOption) (*ResendOTPResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResendOTPResponse)
	err := c.cc.Invoke(ctx, AuthService_ResendVerificationOTP_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetBlockStatus(ctx context.Context, in *GetBlockStatusRequest, opts ...grpc.CallOption) (*GetBlockStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBlockStatusResponse)
	err := c.cc.Invoke(ctx, AuthService_GetBlockStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	ResendVerificationOTP(context.Context, *ResendOTPRequest) (*ResendOTPResponse, error)
...
func (UnimplementedAuthServiceServer) ResendVerificationOTP(context.Context, *ResendOTPRequest) (*ResendOTPResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResendVerificationOTP not implemented")
}
func (UnimplementedAuthServiceServer) GetBlockStatus(context.Context, *GetBlockStatusRequest) (*GetBlockStatusResponse, error) {
...
func _AuthService_ResendVerificationOTP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResendOTPRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ResendVerificationOTP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_ResendVerificationOTP_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ResendVerificationOTP(ctx, req.(*ResendOTPRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_GetBlockStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlockStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetBlockStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetBlockStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetBlockStatus(ctx, req.(*GetBlockStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_ResendVerificationOTP_Handler,
		},
		{
			MethodName: "GetBlockStatus",
			Handler:    _AuthService_GetBlockStatus_Handler,
		},
		{
	...
	Metadata: "api/shared/proto/auth.proto",
}
